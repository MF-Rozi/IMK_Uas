...
?>
                         <?php
                            $renew_query = "SELECT * FROM `users` where `user_id` =$_SESSION[id]";
                            $renew_run = $con -> query($renew_query);
                            $renew_get = $renew_run -> fetch_assoc();
                            if(count($renew_get)>0){
                                $_SESSION['role'] = $renew_get['user_role'];
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">
                            ...
                            <small><?php echo $_SESSION['firstname']; ?> you are <?php
